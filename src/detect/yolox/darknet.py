...
from src.detect.yolox.network_blocks import Focus, DWConv, BaseConv, \
    CSPLayer, ResLayer, SPPBottleneck
...
class Darknet(nn.Module):
    ...
    def __init__(
        ...
        """
        Args:
            depth (int): Depth of darknet used in model, usually use [21, 53]
                for this param.
            in_channels (int): Number of input channels, for example, use 3
                for RGB image.
