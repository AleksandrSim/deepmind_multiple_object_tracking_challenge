...
class Visualization(object):
    ...
    def __init__(self, seq_info, update_ms, dir_to_save=None):
    ...
    def run(self, frame_callback):
        self.viewer.run(lambda: self._update_fun(frame_callback), self.dir_to_save)
    ...
    def draw_detections(self, detections):
        ...
        for i, detection in enumerate(detections):
            ...
            if detection_id>=0:
                self.viewer.rectangle(*detection.tlwh, detection_id,gt=True)
            else:
